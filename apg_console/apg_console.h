...
Version History:
  v0.15.2 - 2025/06/13 - Replaced unsafe string functions.
  ...
  v0.1    - 2020/01/06 - Reduced interface. Moved from stored float cvars to addresses of existing vars. Data type is also specified for bool/int/uint/float
support.
